...
export function Hero({ badge, title, emphasis, body, children }: { badge?: string; title: string; emphasis?: string; body?: string; children?: ReactNode }) {
